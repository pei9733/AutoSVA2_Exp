...
Note: This implementation uses synchronous resets (i.e., the state variables are set to their initial values on the rising edge of the clock when the reset is not asserted).